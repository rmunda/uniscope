        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    // Edit Button
                    $btn .= '<button class="btn btn-outline-success d-flex edit-subject" data-id="'.$row->id.'" data-url="'.$editUrl.'">
                    ...
                    // Delete Button
                    $btn .= '<button class="btn btn-outline-danger d-flex delete-subject" data-id="'.$row->id.'" data-url="'.$deleteUrl.'">
