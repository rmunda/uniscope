        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function($row) {
                    ...
                    // Edit Button
                    $btn .= '<button class="btn btn-outline-success d-flex edit-role" data-id="'.$row->id.'" data-url="'.$editUrl.'">
                    ...
                    // Delete Button
                    $btn .= '<button class="btn btn-outline-danger d-flex delete-role" data-id="'.$row->id.'" data-url="'.$deleteUrl.'">
