<aside class="d-flex flex-column h-100">
    ...
    {{-- TOP: Logo --}}
    <div class="px-3 py-3 border-bottom mx-3 d-flex align-items-center gap-2 sidebar-brand logo-lg">
       <svg xmlns="http://www.w3.org/2000/svg"  fill="none" viewBox="0 0 24 24" id="Space-Rocket-Earth--Streamline-Ultimate" alt="Uniscope Logo">
                <desc>
        ...
        <span class="sidebar-brand-text">Uniscope</span>
    </div>
    ...
    <div class="px-3 pb-3 border-top">
        <div class="d-flex align-items-center gap-2 p-2 rounded" style="background: #f6f8fb;">
            <div class="avatar avatar-sm bg-primary text-white rounded">
                {{ strtoupper(substr(Auth::user()->name, 0, 1)) }}
            </div>
            <div class="lh-sm overflow-hidden">
                <div class="fw-medium text-truncate" style="font-size: 13px;">
                    {{ Auth::user()->name }}
                </div>
